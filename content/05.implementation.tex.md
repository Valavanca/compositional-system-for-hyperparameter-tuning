...
extension libraries [@raw:raw:buitinck2013api]. We introduce new Model-based
...
fashion is by [@raw:raw:EngSurMod] means of a rectangular grid of points. This
...
evaluations [@raw:raw:SoftSurvey].
...
platform[@raw:raw:francesco_biscani_2019] to perform parallel computations of
