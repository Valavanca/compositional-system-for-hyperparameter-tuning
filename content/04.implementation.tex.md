...
fashion is by [@raw:raw:raw:EngSurMod] means of a rectangular grid of points. This
...
A Python platform [@raw:raw:raw:francesco_biscani_2019] to perform parallel
...
-   ZDT [@raw:raw:raw:ZitzlerDT00] is 6 different two-objective scalable problems
...
-   WFG [@raw:raw:raw:WFGref] was conceived to exceed the functionalities of
...
-   DTLZ [@raw:raw:raw:DebTLZ05]. All problems in this test suite are
...
evaluations [@raw:raw:raw:SoftSurvey].
...
extension libraries [@raw:raw:raw:buitinck2013api]. We introduce new Model-based
