\chapter{Background}\label{sec:background}
    ...
    % What is parameter tuning? Why is multi-objective important? Why we cannot use the standard multi-objective approach in real-life problem/parameter tuning task, and why model-based or surrogate optimization is the best solution?
