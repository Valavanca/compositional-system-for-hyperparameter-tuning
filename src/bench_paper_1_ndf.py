...
import os
import logging
logging.basicConfig(filename='./paper_tutor1_ndf.log', level=logging.INFO)
...
if __name__ == "__main__":
    logging.info(
        "----\n Start paper benchamrk 1 ndf \n ---- ")

    print("Start paper benchamrk 1 ndf")
    ...
    with Parallel(prefer='threads') as parallel:
        for param_grid in test_set:
            ...
            file_name = '/benchmark_results/paper_model_tutor_on_{}_{}.{}'.format(
